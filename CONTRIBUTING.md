...
We are using [Github Issues](https://github.com/bytedance/kubewharf/issues) for our public bugs. We keep a close eye on this and try to make it clear when we have an internal fix in progress. Before filing a new task, try to make sure your problem doesn't already exist.
...
### 3. Security Bugs
Please do not report the safe disclosure of bugs to public issues. Contact us by [Support Email](mailto:xuchen.xiaoying@bytedance.com)

## How to Get in Touch
- [Email](mailto:xuchen.xiaoying@bytedance.com)

## Submit a Pull Request
Before you submit your Pull Request (PR) consider the following guidelines:
1. Search [GitHub](https://github.com/bytedance/kubewharf/pulls) for an open or closed PR that relates to your submission. You don't want to duplicate existing efforts.
...
4. [Fork](https://docs.github.com/en/github/getting-started-with-github/fork-a-repo) the bytedance/kubewharf repo.
...
9. Push your branch to GitHub:
    ...
    ```
10. In GitHub, send a pull request to `kubewharf:develop` with a clear and unambiguous title.
